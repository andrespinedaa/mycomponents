...
export const ButtonThemeComponent: ButtonThemeConfig = {
  ...
  variants: {
    Filled: {
      ...
      disabled: { bg: "neutral.200", color: "neutral.400", cursor: "not-allowed" },
    ...
    Outlined: {
      ...
      disabled: { color: "neutral.400", borderColor: "neutral.300", cursor: "not-allowed" },
    },
    Ghost: {
      bg: "transparent",
      color: "primary.500",
    ...
    Elevated: {
      ...
      disabled: { bg: "neutral.100", color: "neutral.400", boxShadow: "none", cursor: "not-allowed" },
    },
  },
};
