...
export const InputThemeComponent: InputThemeConfig = {
  ...
  variants: {
    ...
    focusWithin: { borderColor: "primary.500", shadow: "0 0 0 3px rgba(59,130,246,0.15)" },
    disabled:    { bg: "neutral.100", color: "neutral.400", borderColor: "neutral.200", cursor: "not-allowed", opacity: "0.6" },
    invalid:     { borderColor: "danger.500", shadow: "0 0 0 3px rgba(239,68,68,0.15)" },
    ...
    Filled: {
      ...
      focusWithin: { bg: "neutral.50", borderColor: "primary.500", shadow: "0 0 0 3px rgba(59,130,246,0.15)" },
